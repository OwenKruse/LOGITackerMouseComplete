...
typedef enum {
    ...
    LOGITACKER_USB_HIDRAW_COMMAND_SCRIPT_MOUSE_MOVE = 0x15,
    LOGITACKER_USB_HIDRAW_COMMAND_SCRIPT_MOUSE_CLICK = 0x16,
    LOGITACKER_USB_HIDRAW_COMMAND_SCRIPT_MOUSE_SCROLL = 0x17,
